...
date: 2014-09-2 21:49
comments: true
keywords: github,Android，OpenSrouce
description: 转载自Trinea的git Blog
categories: Android
---



以下内容转载于Trinea的git blog~~~欢迎，更新和补充~！

> 如果你也对开源实现库的实现原理感兴趣，欢迎 Star 和 Fork [Android优秀开源项目实现原理解析](https://github.com/android-cn/android-open-project-analysis)  
> 欢迎加入 QQ 交流群：[63224677](http://shang.qq.com/wpa/qunwpa?idkey=fb2eaf0c4b4a8c838ad15e6bdd69d901f038a50f4a77360845b9e6d7ee0ba3ee "入群理由必须填写群简介问题答案")(入群理由必须填写群介绍问题答案) 
